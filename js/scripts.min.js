jQuery(document).ready(function (a) {
    ...
    if (h.length > 0 && (a(window).on("scroll", function () {
        ...
        b.each(function () {
            var b = a(this), c = b.data("filter-list"), d = b.find("input[type=text]"), e = b.find("input[type=radio]"),
    ...
    }), a(".isotope-grid1").length) var i = a(".isotope-grid1").imagesLoaded(function () {
        i.isotope({
