...
function theme($tmp){
    if($tmp==1){
        ...
        return array('Корзина','Категория','Все');
    }
}
...
<script type="text/javascript">
    ...
    $('.info')  // Обнуляем счетчик
        .click(function() {
            var counter = $(this).attr('data-action');    // Получаем значение
            // Увеличиваем значение на 1
            console.log(counter);            // Выводим количество кликов
        });
</script>
<!-- Page -->
