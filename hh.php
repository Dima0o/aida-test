...
<header class="navbar navbar-sticky">
    ...
    <div class="site-branding">
        <div class="inner">
            ...
            <!-- Site Logo--><a class="site-logo" href="index.html"><img src="img/logo/logo.png" alt="tshop"></a>
        </div>
    </div>
    <!-- Main Navigation-->
    <nav class="site-menu">
...
<div class="offcanvas-wrapper">
    ...
    <!-- Page Content-->
    <div id="blog_page" class="container padding-bottom-2x mb-2">
        <!--середина работы -->
        ...
        return $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data['items'], function (key, val) {
                      $('#blog_page').append('<div class="row align-items-center padding-bottom-2x">\n' +
